...
def predict():
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Reclassify probabilities into 5 classes using quantiles
            ...
            classified[valid_mask] = classes + 1  # Class values: 1 to 5
            ...
            # Return URL of saved map and map bounds
            return jsonify({
                'flood_map_url': f'/static/{final_name}',
                'bounds': bounds
            })
